 ...
 * @date 17/06/2014
 */
public class FormNotifica2 extends javax.swing.JFrame {
...
//            tabelaProcuradoria.deleteRow(jTable1.getSelectedRow());
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        carregaJtableNotificados(jTable1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormNotifica2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormNotifica2().setVisible(true);
            }
        });
    }
