...
public class DocSlipXerCompleto2 extends DocumentoOffice {

    static DossieSlip slip;

    public DocSlipXerCompleto2(String mciEmpresa) {
        this.arquivo = mciEmpresa;
    }

    public DocSlipXerCompleto2() {
    }
...
//            System.out.println("Foi");
    ...
    public void carregarDadosEstatico() {
        try {
            ...
            DossieSlipCompleto slip = new DossieSlipCompleto();
            carregaDadosTXT();
...
//            model.put("campo6", slip.getDcTipo().toString());
...
//            model.put("campo27", slip.getDcSolvencia());
...
//            model.put("campo51", slip.getPaCodig());
...
//            model.put("campo1", slip.getDcAgencia().toString());
            model.put("campo1", slip.getSlip().getDcAgencia().toString());
            model.put("campo2", slip.getSlip().getDcNomeAgencia().toString());
            model.put("campo3", slip.getSlip().getDcNRContrato().toString());
            model.put("campo4", slip.getSlip().getDcPavan().toString());
            model.put("campo5", slip.getSlip().getDcDadosOrigemAg().toString());
            model.put("c6", slip.getSlip().getDcTipo().toString());
            model.put("campo7", slip.getSlip().getDcContrato().toString());
            model.put("campo8", slip.getSlip().getDcDTContratacao().toString());
            model.put("campo9", slip.getSlip().getDcDTVencimento().toString());
            model.put("campo10", slip.getSlip().getDcRFBacen().toString());
            model.put("campo11", slip.getSlip().getDcVLROperacao().toString());
            model.put("campo12", slip.getSlip().getDcNMMutuario().toString());
            model.put("campo13", slip.getSlip().getDcTpMutuario().toString());
            model.put("campo14", slip.getSlip().getDcCPFMutuario().toString());
            model.put("campo15", slip.getSlip().getDcAGMutuario().toString());
            model.put("campo16", slip.getSlip().getDcCNTMutuario().toString());
            model.put("campo17", slip.getSlip().getDcEndMutuario().toString());
            model.put("campo18", slip.getSlip().getDcCEP().toString());
            model.put("campo19", slip.getSlip().getDcCNDSeguro().toString());
            model.put("campo20", slip.getSlip().getDcCNDIOF().toString());
            model.put("campo21", slip.getSlip().getDcCNDAssTec().toString());
            model.put("campo22", slip.getSlip().getDcNTOperacao().toString());
            model.put("campo23", slip.getSlip().getDcFinalidade().toString());
            model.put("campo24", slip.getSlip().getDcPerspectiva().toString());
            model.put("campo25", slip.getSlip().getDcGarantia().toString());
            model.put("campo26", slip.getSlip().getDcAjuizamento().toString());
            ...
            model.put("campo76", slip.getSlip().getCmSldCorrMonAP().toString());
            model.put("campo77", slip.getSlip().getCmSldCorrMonTotal().toString());
            model.put("campo78", slip.getSlip().getJrSldJurEf().toString());
            model.put("campo79", slip.getSlip().getJrSldJurAprop().toString());
            model.put("campo80", slip.getSlip().getJrSldJurTotal().toString());
            model.put("campo81", slip.getSlip().getPrjProjJuros().toString());
            model.put("campo82", slip.getSlip().getPrjProjAcess().toString());
            model.put("campo83", slip.getSlip().getPrjProjCorr().toString());
            model.put("campo84", slip.getSlip().getCampFinal1().toString());
            model.put("campo85", slip.getSlip().getCampFinal2().toString());
            ...
            Logger.getLogger(DocSlipXerCompleto2.class.getName()).log(Level.SEVERE, null, ex);
            ex.printStackTrace();
